      ...
      if (
        ...
        return {
          ...
          datasets: [{
            ...
            backgroundColor: w.props.chartType === "pie" || w.props.chartType === "doughnut"
              ? palette
              : "rgba(139,197,64,.8)",
            borderColor: w.props.chartType === "pie" || w.props.chartType === "doughnut"
              ? palette : "#8BC540",
            borderWidth: 2,
              ...
              <div className="canvas-widget__content" style={isPublished ? { background: "#fff", padding: 0 } : {}}>
                ...
                {w.type === "chart" && chartData && (
                  <ChartPreview
                    ...
                    data={{
                      ...chartData,
                      rawRows: w.props.result.rawRows || w.props.result.data || []
                    }}
                  />
                )}
